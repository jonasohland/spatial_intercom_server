...
export as namespace riedel_rrcs;

declare namespace riedel_rrcs { 
    ...
    interface XMLRPCServerType {
        httpServer: Server;
    }

    interface RRCSServerType {
        server: XMLRPCServerType
    }

    function RRCS_Server(local: Endpoint, remote: Endpoint, callbacks: RRCSServerCallbacks): RRCSServerType;
}
